...
require_once 'app/bits/post-title.php';
require_once 'app/bits/share.php';
require_once 'app/bits/staff-member.php';

// TODO: pos args should be in the url thingy
$post = $postCol->getBySlug($posArgs[0]);
