...
<section class="diagonal patterned">
    <div class="container halves">
        ...
        <div>
            ...
            <p class="editable" style="font-size:1.8rem;">"There aren't many web shops out there that could deliver my vision -- btek is truly skilled at website development." - <a href="#connect-with-sara" onclick="handleRefClick(event, 'Sara Anani')">Sara Anani</a></p>
        </div>
    </div>
</section>
...
<section class="diagonal">
    ...
    <div class="container halves" style="max-width:700px;">
        ...
        <div style="text-align:center;">
            ...
            <p class="editable">Is your website performing?</p>
