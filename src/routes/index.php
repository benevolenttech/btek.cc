...
<section class="hero diagonal">
  <div class="container">
    <h1 style="display:none;">{{ page.heading }}</h1>
    <h2 class="editable">Get more online love in Charm City, hon.</h2>
    <p class="subtext editable">Websites are hard. We're here to help and empower you.</p>
    <!--<p style="margin-bottom:-30px;">What clients are saying &#8595;</p>-->
    <!--<p><a class="button alt" href="/contact/">See Pricing<p></p>-->
  </div>
</section>
  ...
  <div class="container halves">
    <div>
      <ul class="image-list">
        ...
        <li><img src="/images/thumb-lg.png" width="130" style="max-width:80%;" /></li>
      </ul>
    </div>
    <div>
      <p class="hide-above-mobile" style="font-size:60px;">You + <img src="/images/thumb-lg.png" width="55" /></p>
