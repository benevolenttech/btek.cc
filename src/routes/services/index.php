...
$subtitle = ">-";
  We build mobile apps, websites, campaigns and sales operations software for
  high achievers.
$description = ">-";
  We build mobile apps, websites, campaigns and sales operations software for
  high achievers.
    ...
    <div class="container halves">
        <div>
            <ul class="image-list image-list-right">
                <li><a href="/services/mobile-app-development"><img src="/images/bt-hirely.png" width="300" style="max-width:80%;" /></a></li>
            </ul>
        </div>
        <div>
            <p class="hide-above-mobile" style="text-align: center;"><a href="/services/mobile-app-development"><img src="/images/bt-hirely.png" width="200" style="max-width:80%;" /></a></p>
...
<section class="diagonal patterned">
    <div class="container halves">
        <div>
            <p class="hide-above-mobile" style="text-align: center;"><a href="/services/website-marketing"><img src="/images/bt-saraanani.png" width="200" style="max-width:80%;" /></a></p>
        ...
        <div>
            <ul class="image-list">
                <li><a href="/services/website-marketing"><img src="/images/bt-saraanani.png" width="300" style="max-width:80%;" /></a></li>
            </ul>
        </div>
    </div>
</section>
...
<section class="diagonal alternate">
    <div class="container halves">
        <div>
            <ul class="image-list image-list-right">
                <li><a href="/services/salesforce-consulting"><img src="/images/bt-summit-park.png" width="300" style="max-width:80%;" /></a></li>
            </ul>
        </div>
        <div>
            <p class="hide-above-mobile" style="text-align: center;"><a href="/services/salesforce-consulting"><img src="/images/bt-summit-park.png" width="200" style="max-width:80%;" /></a></p>
