    ...
    <div class="container halves">
        <div>
            <ul class="image-list image-list-right">
                <li><a href="#connect-with-matt" onclick="handleRefClick(event, 'Matt Magan')"><img src="/images/bt-summit-park.png" width="300" style="max-width:80%;"/></a></li>
            </ul>
        </div>
        <div>
            <p class="hide-above-mobile" style="text-align: center;"><a href="#connect-with-matt" onclick="handleRefClick(event, 'Matt Magan')" ><img src="/images/bt-summit-park.png" width="200" style="max-width:80%;"/></a></p>
    ...
    <div style="text-align:center; padding:0 20px;">
            ...
            <tr>
                ...
                <td>
                    <a target="_blank" href="https://maps.google.com/?cid=5725988273627858551" >
                        <img style="background:white; padding:15px; width:191px; height:auto;"
                             src="/images/google.png" width="100%"/>
                    </a>
                </td>
                <td>
        ...
        <div class="hide-above-mobile">
            ...
            <p>
                <a target="_blank" href="https://maps.google.com/?cid=5725988273627858551" >
                    <img style="background:white; padding:15px; width:191px; height:auto;"
                         src="/images/google.png" width="60%"/>
                </a>
            </p>
            <br>
            <p>
...
<section class="diagonal">
    ...
    <div class="container halves" style="max-width:700px;">
        ...
        <div style="text-align:center;">
            <p class="hide-above-mobile" style="font-size:60px;">You + <img src="/images/thumb-lg.png"
                                                                            width="55"/></p>
