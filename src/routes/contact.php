...
$description = "We'd love to help your business with it's SEO, marketing, and website development.";
...
<section class="diagonal">
	<div class="container halves aligned-top">
		<div>
			<h3>Address</h3>
				<address> <!--{{ page.map.address | replace: ", ", ", <br>" }}-->
					<a target="_blank" href="https://www.google.com/maps/place/{{ page.map.address | url_encode }}">	<!--{{ page.map.address | replace: ", ", ", <br>" }}-->
