  ...
  <div class="container halves">
    <div>
      <ul class="image-list image-list-right">
        <li><a href="#connect-with-alan" onclick="handleRefClick(event, 'Alan Magan')"><img src="/images/bt-apmfoodworks.png" width="300" style="max-width:80%;"/></a></li>
      </ul>
    </div>
    <div>
      <p class="hide-above-mobile" style="text-align: center;"><a href="#connect-with-alan" onclick="handleRefClick(event, 'Alan Magan')"><img src="/images/bt-apmfoodworks.png" width="200" style="max-width:80%;"/></a></p>
...
<section class="diagonal patterned">
  <div class="container halves">
    <div>
      <p class="hide-above-mobile" style="text-align: center;"><a href="#connect-with-sara" onclick="handleRefClick(event, 'Sara Anani')"><img src="/images/bt-saraanani.png" width="200" style="max-width:80%;"/></a></p>
    ...
    <div>
      <ul class="image-list">
        <li><a href="#connect-with-sara" onclick="handleRefClick(event, 'Sara Anani')"><img src="/images/bt-saraanani.png" width="300" style="max-width:80%;"/></a></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="diagonal alternate">
  <div class="container halves">
    <div>
      <ul class="image-list image-list-right">
        <li><a href="#connect-with-hirely" onclick="handleRefClick(event, 'the Hirely team')"><img src="/images/bt-hirely.png" width="300" style="max-width:80%;"/></a></li>
      </ul>
    </div>
    <div>
      <p class="hide-above-mobile" style="text-align: center;"><a href="#connect-with-hirely" onclick="handleRefClick(event, 'the Hirely team')"><img src="/images/bt-hirely.png" width="200" style="max-width:80%;"/></a></p>
...
<section class="diagonal patterned">
  <div class="container halves">
    <div>
      <p class="hide-above-mobile" style="text-align: center;"><a href="#connect-with-productmaven" onclick="handleRefClick(event, 'Ryan Troll')"><img src="/images/bt-product-maven.png" width="200" style="max-width:80%;"/></a></p>
    ...
    <div>
      <ul class="image-list">
        <li><a href="#connect-with-productmaven" onclick="handleRefClick(event, 'Ryan Troll')"><img src="/images/bt-product-maven.png" width="300" style="max-width:80%;"/></a></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="diagonal alternate">
  <div class="container halves">
    <div>
      <ul class="image-list image-list-right">
        <li><a href="https://seasonstherapy.com" target="_blank"><img src="/images/bt-seasons-therapy.png" width="300" style="max-width:80%;"/></a></li>
      </ul>
    </div>
    <div>
      <p class="hide-above-mobile" style="text-align: center;"><a href="https://www.seasonstherapy.com" target="_blank"><img src="/images/bt-seasons-therapy.png" width="200" style="max-width:80%;"/></a></p>
