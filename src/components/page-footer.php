...
require_once 'src/components/social-icon.php';
    ...
    <div class="container">
      ...
      <div class="footer-columns">
              ...
              <li>
                <a <?php if ($link['new_window']) echo 'target="_blank"'; ?> href="<?php echo $link['link']; ?>" <?php if (isset($link['social_icon'])) echo 'class="' . strtolower($link['social_icon']) . '-icon"'; ?>>
                  <?php if (isset($link['social_icon'])) : ?>
                    <img src="<?php socialIcon($link['social_icon']); ?>">
                  <?php endif; ?>
        ...
        <ul class="footer-links">
          ...
          <li><a href="<?php echo $site->url; ?>/feed.xml"><?php socialIcon('RSS'); ?> Subscribe with RSS</a></li>
        </ul>
      </div>
