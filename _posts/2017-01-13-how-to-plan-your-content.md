...
**The Google AdWords Keyword Planner will reveal real world Google search statistics and recommendations based on those statistics.**
...
2) [SEMrush](http://www.semrush.com/) allows you to run a number of free reports that show you the top keywords for the domain you enter. This is a quick way to get a sense of the types of terms your competitors are ranking for.
